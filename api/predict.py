...
JSON_SCHEMA_HINT = """{
  ...
  "summary": "<A highly detailed, comprehensive clinical diagnosis summary (at least 4-5 sentences) explaining the visual symptoms, pathological reasoning, and severity>",
  "symptoms": ["<Symptom 1>", "<Symptom 2>", "<Symptom 3>"],
  "treatment": ["<Title: Detailed scientific explanation of treatment steps>", "<Title: Detailed explanation>"],
